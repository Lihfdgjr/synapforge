...
- [x] (02:50, 70dc6a0, --log-grad-norm flag + 4 tests)
...
## T6.3 — README badges
- [x] (01:56, 7ba44f4, 5 badges added, all return 200)
...
- [x] (02:53, bc8ec4a, opened 7 GitHub Issues for historical bugs; see docs/HISTORY_ISSUES.md)
...
- [x] (02:16, 9198997, changelog_helper.py + phase relauncher wire-in (PAR_SKIP_CHANGELOG opt-out) + 6 tests pass)
...
- [x] (02:50, b46d3ac, 8 tweet drafts for milestone triggers — STDP/R-fold/NeuroMCP/STDP-unlock/Phase1/Phase2/chat-grade/OSS-frame in docs/SOCIAL_DRAFTS.md, all 243-278 chars, ASCII-only, github.com link each)
